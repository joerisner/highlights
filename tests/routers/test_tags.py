...
def test_get_all_tags_returns_list_of_tags(client: TestClient, mock_tags):
...
def test_get_tag_by_id_found(client: TestClient):
...
def test_get_tag_by_id_not_found(client: TestClient):
